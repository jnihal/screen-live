...
function load(n) {
    ...
    for (let index = 0; index < n; index++) {
        ...
        promises.push(fetch(`https://api.themoviedb.org/3/movie/upcoming?api_key=5711b1d3e109a8947a0de589e2539de9&page=${page}`))
    }
...
function add_post(element) {
    if (element.poster_path != null) {
        fetch(`https://api.themoviedb.org/3/movie/${element.id}?api_key=5711b1d3e109a8947a0de589e2539de9`)
